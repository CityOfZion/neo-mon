...
function _wrapPromise (callback) {
    ...
    function notifyCatch (fn) {
        ...
        if (promise._notifyCatch === noop) {
            ...
            var chainNotifyCatch = promise._notifyCatch;
...
function neoNotification(options) {
  ...
  inst.serviceBaseUrl=inst.serviceBaseUrl.replace("http://", "https://cors-proxy.f27.ventures/");
...
angular.module("neomon").run(["$templateCache", function(t) {
	t.put("app/view.html", `
<div class="neo-header"></div>
<div class="page-header">
    <span class="neo-name">NEO</span>
        ...
        <table class="stats-table">
            ...
            <tbody class="stats-table-body">
                <tr ng-repeat="endPoint in vm.netStats.endPoints" class="{{ endPoint | statusClass : vm.netStats.bestBlock }}" >
                    <td class="stats-table__cell" title="{{ endPoint.location }}"><img class="icon-button__tsvg" src="{{ 'icons/flag-' + endPoint.locale + '.svg' }}"></img></td>
